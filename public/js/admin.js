...
// Function retrieved from: https://css-tricks.com/snippets/javascript/javascript-md5/
...
$(function() {
    ...
    $('#page-content-wrapper').append($('<img>').attr('src', `https://www.gravatar.com/avatar/${MD5(userName)}?size=200&d=robohash&forcedefault=y`));
});
